...
/**
 * Servlet implementation class StHuyBaiPostController
 */
@WebServlet("/StHuyBaiPostController")
public class StHuyBaiPostController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StHuyBaiPostController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			 ...
			 result = dao.updateSatus(9,Postid);			
