...
/**
 * Servlet implementation class StTuChoiController
 */
@WebServlet("/StTuChoiController")
public class StTuChoiController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StTuChoiController() {
        super();
