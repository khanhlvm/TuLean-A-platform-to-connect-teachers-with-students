...
/**
 * Servlet implementation class GsTuChoiController
 */
@WebServlet("/GsTuChoiController")
public class GsTuChoiController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GsTuChoiController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			 ...
			 result = dao.updateSatus(6,Postid,Tutorid);			
