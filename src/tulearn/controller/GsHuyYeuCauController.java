...
/**
 * Servlet implementation class GsHuyYeuCauController
 */
@WebServlet("/GsHuyYeuCauController")
public class GsHuyYeuCauController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GsHuyYeuCauController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			result= dao.updateSatus(7,Postid,Tutorid);
