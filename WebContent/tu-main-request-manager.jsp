...
<div id="main">
	...
	<div id="London" class="tabcontent">
		...
		<c:forEach items="${requestScope.LIST_REQ}" var="req">
			<form action="GsHuyYeuCauController" method="GET">
				<article class="post">
					...
					<div class="body_tokyo">
						...
						<div class="body_second">
							...
							<input type="hidden" name="btnTutorID"
								value="${req.tutor.userID}"> <input type="hidden"
								name="btnPostID" value="${req.post.postID}">
	...
	<div id="Paris" class="tabcontent">
		...
		<c:forEach items="${requestScope.LIST_REQGS}" var="reqe">
			<form action="GsTuChoiController" method="GET">
				<article class="post">
					<header class="header_post">
						<div class="title">

							<h3>
								Học Viên <span>${reqe.post.learner.name}</span> đăng kí học với
								bạn
							</h3>
						</div>
					...
					<footer class="footer_jc">
						...
						<input
							type="submit" class="button btn"
							formaction="GsChapNhanController" value="Chấp Nhận">
					</footer>
				</article>
			</form>
		</c:forEach>
