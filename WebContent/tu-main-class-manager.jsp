        ...
        <div id="main">
            ...
            <div id="London" class="tabcontent">
                ...
                <article class="post">
                    ...
                    <footer>
                     <a href="GsCapNhatTrangThaiController?tutorID=${req.tutor.userID}" class="button btn">Cập nhật</a>
                    </footer>
                </article>
                 </c:forEach>
            </div>
                ...
                <article class="post">
                    <div class="row">
                        ...
                        <div class="col-6 col-12-medium">
                            ...
                            <div class="body_text">
                                <span>Họ và Tên:</span>
                                <p>${reqe.post.learner.name}</p><br>

                            </div>
                            <div class="body_text">
                                <span>Địa chỉ:</span>
                               <p>${reqe.post.learner.street},${reqe.post.address.communeName},${reqe.post.address.districtName},${reqe.post.address.provinceName}</p>


                            </div>
                            <div class="body_text">
                                <span>SĐT:</span>
                               <p>${reqe.post.learner.phone}</p>
                            </div>
                        </div>
            ...
            <div id="XH" class="tabcontent">
                ...
                <form action="GsXoaLopHocController" method="GET">
                <article class="post">
                    <div class="row">
                        ...
                        <div class="col-6 col-12-medium">
                            ...
                            <div class="body_text">
                                ...
                                <span>Môn học:</span>
                                 <p>${re.post.subject.sName}</p><br>
                            </div>
                            <div class="body_text">

                                <span>Số buổi/Tuần:</span>
                                 <p>${re.post.timeLearn}</p><br>
                            </div>
                            <div class="body_text">
                        ...
                        <div class="col-6 col-12-medium">
                            ...
                            <div class="body_text">
                                <span>Họ và Tên:</span>
                                <p>${re.post.learner.name}</p><br>

                            </div>
                            <div class="body_text">
                                <span>Địa chỉ:</span>
                                <p>${re.post.learner.street},${re.post.address.communeName},${re.post.address.districtName},${re.post.address.provinceName}</p>

                            </div>
                            <div class="body_text">
                                <span>SĐT:</span>
                                 <p>${re.post.learner.phone}</p>
                            </div>
                            <div class="body_text">

								<input type="hidden" name="btnTutorID" value="${re.tutor.userID}">
								 <input type="hidden" name="btnPostID" value="${re.post.postID}">
